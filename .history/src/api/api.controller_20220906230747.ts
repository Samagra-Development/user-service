...
export class ApiController {
  ...
  getHello(): any {
      ...
      const host = this.configResolverService.getHost("post");
      const apiKey = this.configResolverService.getApiKey("post");
      const encStatus = this.configResolverService.getEncryptionStatus("post");
      const encKey = this.configResolverService.getEncryptionKey("post");
