import { LoginResponse, User } from '@fusionauth/typescript-client';
import ClientResponse from '@fusionauth/typescript-client/build/src/ClientResponse';
import { Injectable } from '@nestjs/common';
import { ConfigService } from '@nestjs/config';
import { ResponseCode, ResponseStatus, SignupResponse, UsersResponse } from './api.interface';
...
export class ApiService {
  ...
  async updatePassword(data: {loginId: string, password: string, applicationId?: string}): Promise<any> {
