...
export class ApiController {
  ...
  @Post('signup')
  async createUser(@Body() data: UserRegistration, @Headers('authorization') authHeader): Promise<SignupResponse> {
    if( authHeader != null){
        data['authHeader'] = authHeader;
    }
  ...
  async updateUser(
    ...
    const user: SignupResponse = await this.apiService.updateUser(userId, data, applicaionId, authHeader);
    return user;
  }
